<div class="content">
    <div class="col-sm-4">
        ...
        <form name="form" novalidate ng-app="" ng-controller="stageController">
                ...
                <span ng-show="form.date.$error.required"> Sisestada s[nnikuup'ev.</span></span><br>
                
                <label for="education">Haridus:</label>
                <input type="text" name="education" ng-model="education" required>
                ...
                <input type="text" name="job" ng-model="job" required>
